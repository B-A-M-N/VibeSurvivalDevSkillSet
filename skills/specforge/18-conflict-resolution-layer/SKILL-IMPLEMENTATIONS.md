# 18-conflict-resolution-layer -- Implementation Guide
========================================================
...
Phase5: Spec Construction
  Agent: specforge-architect
  Skill: 18-conflict-resolution-layer
  Output: MASTER_SPEC.md (PART 15)
```
...
```yaml
---
name: 18-conflict-resolution-layer
description: |
...
skill_files = [
  "skills/specforge/18-conflict-resolution-layer/SKILL.md",
]
```

## Connects To

- **Previous:** `17-hard-gate-definition` (Phase5: Spec Construction)
- **Next:** `19-scenario-matrix-generation` (Phase6: Scenarios)
