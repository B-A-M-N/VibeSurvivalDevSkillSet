# 20-kill-test-generation -- Implementation Guide
===================================================
...
skill_files = [
  "skills/specforge/20-kill-test-generation/SKILL.md",
]
```

## Connects To

- **Previous:** `19-scenario-matrix-generation` (Phase6: Scenarios)
- **Next:** `21-adversarial-spec-review` (Phase7: Adversarial Review)
