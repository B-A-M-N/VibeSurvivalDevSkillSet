# 06-requirement-normalization -- Implementation Guide
========================================================
...
**Output:** MASTER_SPEC.md (PARTs 1-3)
...
Phase5: Spec Construction
  Agent: specforge-architect
  Skill: 06-requirement-normalization
  Output: MASTER_SPEC.md (PARTs 1-3)
```
...
```yaml
---
name: 06-requirement-normalization
description: |
...
skill_files = [
  "skills/specforge/06-requirement-normalization/SKILL.md",
]
```

## Connects To

- **Previous:** `05-targeted-domain-research` (Phase4: Research)
- **Next:** `07-authority-boundary-definition` (Phase5: Spec Construction)
