# 12-ui-behavior-specification -- Implementation Guide
========================================================
...
Phase5: Spec Construction
  Agent: specforge-architect
  Skill: 12-ui-behavior-specification
  Output: MASTER_SPEC.md (PART 8)
```
...
```yaml
---
name: 12-ui-behavior-specification
description: |
...
skill_files = [
  "skills/specforge/12-ui-behavior-specification/SKILL.md",
]
```

## Connects To

- **Previous:** `11-api-contract-specification` (Phase5: Spec Construction)
- **Next:** `13-security-permission-specification` (Phase5: Spec Construction)
