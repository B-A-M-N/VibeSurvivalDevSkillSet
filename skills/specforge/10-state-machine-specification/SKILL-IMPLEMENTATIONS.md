# 10-state-machine-specification -- Implementation Guide
==========================================================
...
Phase5: Spec Construction
  Agent: specforge-architect
  Skill: 10-state-machine-specification
  Output: MASTER_SPEC.md (PART 5)
```
...
```yaml
---
name: 10-state-machine-specification
description: |
...
skill_files = [
  "skills/specforge/10-state-machine-specification/SKILL.md",
]
```

## Connects To

- **Previous:** `09-execution-flow-specification` (Phase5: Spec Construction)
- **Next:** `11-api-contract-specification` (Phase5: Spec Construction)
