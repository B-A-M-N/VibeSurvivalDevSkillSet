# 09-version-compatibility-research -- Implementation Guide
=============================================================
...
Phase4: Targeted Research
  Agent: researchforge-researcher
  Skill: 09-version-compatibility-research
  Output: RESEARCH_FINDINGS.md
```
...
```yaml
---
name: 09-version-compatibility-research
description: |
...
skill_files = [
  "skills/researchforge/09-version-compatibility-research/SKILL.md",
]
```

## Connects To

- **Previous:** `08-upstream-issue-research` (Phase4: Targeted Research)
- **Next:** `10-architecture-pattern-research` (Phase4: Targeted Research)
