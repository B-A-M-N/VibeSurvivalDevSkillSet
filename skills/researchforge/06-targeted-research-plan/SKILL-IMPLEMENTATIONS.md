# 06-targeted-research-plan -- Implementation Guide
=====================================================
...
Phase4: Targeted Research
  Agent: researchforge-researcher
  Skill: 06-targeted-research-plan
  Output: RESEARCH_PLAN.md
```
...
```yaml
---
name: 06-targeted-research-plan
description: |
...
skill_files = [
  "skills/researchforge/06-targeted-research-plan/SKILL.md",
]
```

## Connects To

- **Previous:** `05-hypothesis-disconfirmation` (Phase3: Hypotheses)
- **Next:** `07-official-docs-research` (Phase4: Targeted Research)
