...
from systems.researchforge.agent_loop import (
    enter_researchforge, exit_researchforge, run_phase, get_available_phases
)


class TestResearchForgeFiles:
...
class TestResearchForgeAgentLoop:
    """Test the agent_loop functions."""

    def test_enter_returns_string(self):
        result = enter_researchforge()
        assert isinstance(result, str), "enter_researchforge should return str"

    def test_exit_returns_string(self):
        result = exit_researchforge()
        assert isinstance(result, str), "exit_researchforge should return str"
